"""SQLite-backed generic trajectory recorder with JSONL mirroring."""
...
class TrajectoryRecorder:
    ...
    The physical ``map_id`` column is the v1 compatibility storage for the
    domain-independent ``instance_id`` API. No schema migration is performed.
